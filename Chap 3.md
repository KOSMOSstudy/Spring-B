...
- Hibernate 대신 Spring Data JPA를 사용하는 이유 1. 구현체 교체의 용이성 - Hibernate 외의 다른 구현체로 쉽게 교체하기 위해 2. 저장소 교체의 용이성 - 관계형 데이터베이스 외에 다른 저장소로 쉽게 교체하기 위해
  <br />
...
3.  **[domain/posts/Posts]** 패키지, 클래스 생성 - code
            ```java
...
- e.g., 주문 취소
  ...
  ```
- DB에 데이터 업데이트 - 변경: 이벤트에 맞는 **public 메소드** 호출 - 삽입: **생성자 혹은 @Builder**를 통해 채운 후 삽입 - 빌더 패턴 권장
  <br />
